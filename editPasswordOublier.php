...
<body>
    ...
    <main>
      ...
      <div class="third">
          <div class="form">
              <form action="editPasswordOublier.php?idU=<?php echo $_GET['idU'] ?>" method="Post" id="change_pass">
              <div class="input">
            ...
            if(isset($_POST['OkPass']))
            {
              ...
              if (!empty($_POST['pass']) && !empty($_POST['passconfirmer'])) {

    ...
    <body id="body">
        ...
        <main>
            <section class="first">
              ...
              <p id="titre">
                  Gérez les utilisateurs, produits aussi les catégories, ainsi que la confidentialité et la sécurité de vos
                  données pour profiter au mieux des services Sport Store
             </p>
